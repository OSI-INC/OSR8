...
; pass the number of byte to be rotated in A. The routine 
; shifts the carry flag into the bottom bit of the first byte
; and shifts the top bit of the last byte into the carry flag.
; Pointer IX and Register A are returned with their original
; values intact. The routine takes 21 + 9N clock cycles to 
; complete, including the call.
